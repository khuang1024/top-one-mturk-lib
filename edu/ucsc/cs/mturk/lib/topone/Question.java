...
class Question {
	...
	public static void main(String[] args){
		...
		urls.add("http://users.soe.ucsc.edu/~khuang/testpic/testpic (1).jpg");
		urls.add("http://users.soe.ucsc.edu/~khuang/testpic/testpic (2).jpg");
		urls.add("http://users.soe.ucsc.edu/~khuang/testpic/testpic (3).jpg");
		urls.add("http://users.soe.ucsc.edu/~khuang/testpic/testpic (4).jpg");
		Question q = new Question(urls, 2);
