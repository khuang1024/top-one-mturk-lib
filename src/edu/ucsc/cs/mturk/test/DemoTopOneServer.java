...
public class DemoTopOneServer {
    ...
    private static final String algorithmServerIp = "stardance.cse.ucsc.edu";
    ...
    /**
     * 
     * @param args The first two arguments are the target server's IP
     * and port, where an instance of algorithm is created and run.
     * @throws IOException 
	...
	while (true) {
	    ...
	    Socket s = ss.accept();
	    new Thread(new DemoTopOneServerThread(s, propertyFileName));
	}
